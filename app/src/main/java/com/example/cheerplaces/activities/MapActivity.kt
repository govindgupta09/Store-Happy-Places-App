...
import com.example.cheerplaces.databinding.ActivityMapBinding
...
class MapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        /**
         * Adding a marker on the location using the latitude and longitude and move the camera to it.
         */
        val position = LatLng(
