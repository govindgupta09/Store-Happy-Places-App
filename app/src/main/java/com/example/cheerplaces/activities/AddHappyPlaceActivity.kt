...
import com.example.cheerplaces.databinding.ActivityAddHappyPlaceBinding
import com.example.cheerplaces.models.HappyPlaceModel
import com.example.cheerplaces.utils.GetAddressFromLatLng
...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // setting toolbar to our custom toolbar and also set back button
        ...
        if (!Places.isInitialized()) {
            Places.initialize(
                ...
                resources.getString(R.string.my_google_maps_api_key)
            )
        }
        ...
        Dexter.withActivity(this)
            ...
            .withListener(object : MultiplePermissionsListener {
                override fun onPermissionsChecked(report: MultiplePermissionsReport?) {
                    ...
                    // Here after all the permission are granted launch the gallery to select and add image.
        ...
        when (v!!.id) {
            ...
            R.id.et_location -> {
                try {
                    ...
                    Toast.makeText(
                        this,
                        "Some error on searching, please try later",
                        Toast.LENGTH_SHORT
                    ).show()
                    e.printStackTrace()
                }
                        ...
                        .withListener(object : MultiplePermissionsListener {
                            override fun onPermissionsChecked(report: MultiplePermissionsReport?) {
                                if (report!!.areAllPermissionsGranted()) {
                                    Toast.makeText(
                                        this@AddHappyPlaceActivity,
                                        "Selecting current location : please wait..!!",
                                        Toast.LENGTH_SHORT
                                    ).show()
